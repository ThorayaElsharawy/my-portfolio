            ...
            {PROJECTS.map((project) => {
                return (
                    <div key={project.id}
                        ...
                        className={`mb-5 lg:p-4 md:flex items-start gap-4 text-white hover:bg-white/5  transition-all duration-300 cursor-pointer rounded-lg group hover:shadow-[0_0_5px_#3e124778]  ${active === null ? 'opacity-100' : active !== project.id && 'opacity-40'}`}>
